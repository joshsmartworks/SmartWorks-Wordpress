...
$tcvpb_elements['abbr_dd'] = array(
	'name' => esc_html__('Abbreviation', 'ABdev_incomeup' ),
	'type' => 'inline',
	'attributes' => array(
		'fullword' => array(
			'info' => esc_html__('e.g. Abbreviation', 'ABdev_incomeup'),
			'description' => esc_html__('Full Word', 'ABdev_incomeup'),
		),
		'abbr' => array(
			'info' => esc_html__('e.g. abbr', 'ABdev_incomeup'),
			'description' => esc_html__('Abbreviation', 'ABdev_incomeup'),
		),
		'id' => array(
