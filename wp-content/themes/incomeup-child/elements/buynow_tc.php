...
$tcvpb_elements['buynow_tc'] = array(
	'name' => esc_html__('BuyNow PayPal Button', 'ABdev_incomeup' ),
	'type' => 'block',
	'icon' => 'pi-paypal',
	...
	'attributes' => array(
		...
		'item_name' => array(
			'description' => esc_html__('Item Name', 'ABdev_incomeup'),
		),
		'item_number' => array(
			'description' => esc_html__('Item Number', 'ABdev_incomeup'),
		),
		'price' => array(
			'description' => esc_html__('Item Price', 'ABdev_incomeup'),
			'divider' => 'true',
		),
		'currency' => array(
			'default' => 'USD',
		...
		'tax_rate' => array(
			'default' => '0',
			'description' => esc_html__('Tax Rate', 'ABdev_incomeup'),
		),
		'shipping' => array(
			'default' => '0',
			'description' => esc_html__('Shipping Cost', 'ABdev_incomeup'),
		),
		'id' => array(
