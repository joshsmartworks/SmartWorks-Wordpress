...
$tcvpb_elements['highlight_tc'] = array(
	'name' => esc_html__('Highlighted text', 'ABdev_incomeup' ),
	'type' => 'inline',
	'attributes' => array(
		'color' => array(
			'type' => 'coloralpha',
			'description' => esc_html__('Highlight Color', 'ABdev_incomeup'),
		),
		'text_color' => array(
			'type' => 'color',
			'description' => esc_html__('Text Color', 'ABdev_incomeup'),
		),
		'id' => array(
	...
	'content' => array(
		'description' => esc_html__('Highlighted Content', 'ABdev_incomeup'),
	),
);
