...
if( in_array('revslider/revslider.php', get_option('active_plugins')) ){ //first check if plugin is installed
	...
	$tcvpb_elements['rev_slider'] = array(
		'name' => esc_html__('Revolution Slider', 'ABdev_incomeup' ),
		'description' => esc_html__('Revolution Slider', 'ABdev_incomeup'),
		'type' => 'block',
		'icon' => 'pi-slider',
		...
		'attributes' => array(
			'alias' => array(
				'description' => esc_html__('Slider Alias', 'ABdev_incomeup'),
				'default' => '',
				'type' => 'select',
