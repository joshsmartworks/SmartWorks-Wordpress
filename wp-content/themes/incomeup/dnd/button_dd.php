	...
	'attributes' => array(
		...
		'color' => array(
			...
			'values' => array(
				...
				'orange' =>  __( 'Orange', 'dnd-shortcodes' ),
				'blue' =>  __( 'Blue', 'dnd-shortcodes' ),
				'red' =>  __( 'Red', 'dnd-shortcodes' ),
				'cyan' =>  __( 'Cyan', 'dnd-shortcodes' ),
				'purple' =>  __( 'Purple', 'dnd-shortcodes' ),
				'pink' =>  __( 'Pink', 'dnd-shortcodes' ),
		...
		'transparent' => array(
			'description' => __( 'Transparent', 'dnd-shortcodes' ),
			'default' => '0',
			'type' => 'checkbox',
		),
		'url' => array(
...
function ABdevDND_button_dd_shortcode( $atts, $content = null ) {
	...
	$class_out .= ($transparent) ? ' dnd-button_transparent' : '';
	$class_out .= ' '.$class;
