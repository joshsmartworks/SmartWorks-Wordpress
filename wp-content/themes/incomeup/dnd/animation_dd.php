...
function ABdevDND_animation_dd_shortcode( $attributes, $content = null ) {
	...
	return '<div class="dnd-animo '.esc_attr($class).'" data-animation="'.esc_attr($animation).'" data-duration="'.esc_attr($duration).'" data-delay="'.esc_attr($delay).'">'.do_shortcode($content).'</div>';
}
