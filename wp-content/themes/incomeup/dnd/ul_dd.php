...
function ABdevDND_ul_dd_shortcode( $attributes, $content = null ) {
	...
	return '<ul class="dnd_shortcode_ul '.esc_attr($class).esc_attr($animation_class).'"'.$animation_animation.$animation_duration.$animation_delay.'>'.do_shortcode($content).'</ul>';
}
