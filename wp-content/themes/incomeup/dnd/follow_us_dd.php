...
function ABdevDND_follow_us_dd_shortcode( $attributes ) {
	...
	if($googleplus!='')
		$return.='<a class="dnd_socialicon dnd_socialicon_googleplus dnd_tooltip" data-gravity="s" href="'.esc_url($googleplus).'" target="_blank" title="'.esc_attr__('Follow us on Google+', 'dnd-shortcodes').'"><i class="ci_icon-googleplus"></i></a>';
	if($linkedin!='')
	...
	if($blogger_blog!='')
		$return.='<a class="dnd_socialicon dnd_socialicon_blogger_blog dnd_tooltip" data-gravity="s" href="'.esc_url($blogger_blog).'" target="_blank" title="'.esc_attr__('Our Blogger Blog', 'dnd-shortcodes').'"><i class="ci_icon-blogger-blog"></i></a>';
	if($delicious!='')
	...
	if($email!='')
		$return.='<a class="dnd_socialicon dnd_socialicon_emailalt dnd_tooltip" data-gravity="s" href="'.esc_url('mailto:'.$email).'" target="_blank" title="'.esc_attr__('Send Us Email', 'dnd-shortcodes').'"><i class="ci_icon-emailalt"></i></a>';
	if($flickr!='')
	...
	if($picasa!='')
		$return.='<a class="dnd_socialicon dnd_socialicon_picasa dnd_tooltip" data-gravity="s" href="'.esc_url($picasa).'" target="_blank" title="'.esc_attr__('Our Picasa Profile', 'dnd-shortcodes').'"><i class="ci_icon-picasa"></i></a>';
	if($skype!='')
