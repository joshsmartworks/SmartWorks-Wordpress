...
<p><?php printf( esc_html__( "Hi there. Your recent order on %s has been completed. Your order details are shown below for your reference:", 'ABdev_incomeup' ), get_option( 'blogname' ) ); ?></p>
