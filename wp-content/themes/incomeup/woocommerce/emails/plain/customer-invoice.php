...
if ( $order->status == 'pending' )
	echo sprintf( esc_html__( 'An order has been created for you on %s. To pay for this order please use the following link: %s', 'ABdev_incomeup' ), get_bloginfo( 'name' ), $order->get_checkout_payment_url() ) . "\n\n";
