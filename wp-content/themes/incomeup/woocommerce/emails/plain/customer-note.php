...
echo esc_html__( "Hello, a note has just been added to your order:", 'ABdev_incomeup' ) . "\n\n";
...
echo esc_html__( "For your reference, your order details are shown below.", 'ABdev_incomeup' ) . "\n\n";
