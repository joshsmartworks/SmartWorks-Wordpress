        	...
        	<table border="0" height="100%" width="100%">
            	<tr>
                	<td align="center" valign="top">
                		...
                		?>
                    	<table border="0" width="600" id="template_container" style="<?php echo $template_container; ?>">
                        	<tr>
                            	<td align="center" valign="top">
                                    <!-- Header -->
                                	<table border="0" width="600" id="template_header" style="<?php echo $template_header; ?>" bgcolor="<?php echo $base; ?>">
                                        <tr>
                                            <td>
                        	...
                        	<tr>
                            	<td align="center" valign="top">
                                    <!-- Body -->
                                	<table border="0" width="600" id="template_body">
                                    	<tr>
