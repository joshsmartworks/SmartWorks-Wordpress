	...
	<div class="single_thumb_wrapper">
		...
		<div class="thumbnails"><?php
			...
			foreach ( $attachment_ids as $attachment_id ) {
				...
				echo apply_filters( 'woocommerce_single_product_image_thumbnail_html', sprintf( '<img src="%s" class="%s" title="%s" />', $image_link, $image_class, $image_title ), $attachment_id, $post->ID, $image_class );
