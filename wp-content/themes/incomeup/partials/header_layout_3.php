...
<header id="ABdev_main_header" class="clearfix header_layout_3 <?php echo esc_attr($class_invert) .' '. esc_attr($sticky_header_class) ?> ">
	...
	<div id="logo_search_bar">
		<div class="container">
			<div class="row">
				...
				<?php $slogan = get_theme_mod('slogan', false); ?>
				<div class="slogan"><?php ($slogan != '') ? esc_html_e($slogan) : ''; ?></div>
			</div>
		</div>
	</div>
