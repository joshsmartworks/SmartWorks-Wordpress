...
<header id="ABdev_main_header" class="clearfix header_layout_1 <?php echo esc_attr($class_invert) .' '. esc_attr($sticky_header_class) ?> ">
		...
		<div class="container">
			<div class="row">
				<div id="header_social_info" class="span8">
					...
					if($header_email!=''): ?>
						<span class="quick_contact_mail"><i class="ci_icon-envelope"></i><a href="<?php echo esc_url('mailto:'.$header_email)?>"><?php echo esc_html($header_email); ?></a></span>
					<?php endif; ?>
			...
			<div class="row">
				...
				<?php if( in_array('woocommerce/woocommerce.php', get_option('active_plugins')) ):?>
					...
					<?php if( is_user_logged_in() ) : ?>
						<p><?php _e( 'Welcome, ', 'ABdev_incomeup' ); ?><?php echo $current_user->display_name; ?></p>
					<?php else: ?>
						<?php if(isset($myaccount_page_url)): ?>
							<p><?php _e( 'Welcome, Guest', 'ABdev_incomeup' ); ?><a class="my_account_link" href="<?php echo esc_url($myaccount_page_url); ?>"><?php _e( 'Login', 'ABdev_incomeup' ); ?></a></p>
						<?php endif; ?>
					<?php endif; ?>
				<?php endif; ?>
