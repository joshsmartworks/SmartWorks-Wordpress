...
define( 'THEMENAME', 'IncomeUp' );

require_once dirname( __FILE__ ) . '/class-tgm-plugin-activation.php';

add_action( 'tgmpa_register', 'incomeup_register_required_plugins' );

function incomeup_register_required_plugins() {
	...
	$theme_text_domain = 'ABdev_incomeup';
