...
$tcvpb_elements['chart_radar_tc'] = array(
	'name' => esc_html__('Chart Radar', 'ABdev_incomeup' ),
	'type' => 'block',
	'icon' => 'pi-chart-radar',
	...
	'attributes' => array(
		...
		'labels' => array(
			'description' => esc_html__('Labels', 'ABdev_incomeup'),
			'info' => esc_html__('Type labels with commas and without spaces(e.g. Eating,Drinking,Sleeping,Designing,Coding,Cycling,Running)', 'ABdev_incomeup'),
		),
		'id' => array(
...
$tcvpb_elements['chart_radars_tc'] = array(
	...
	'attributes' => array(
		...
		'data' => array(
			'description' => esc_html__('Radar Points', 'ABdev_incomeup'),
