...
$tcvpb_elements['spacer_tc'] = array(
	'name' => esc_html__('Spacer', 'ABdev_incomeup' ),
	'notice' => esc_html__('This shortcode will add additional vertical space between elements', 'ABdev_incomeup'),
	'icon' => 'pi-spacer',
	...
	'attributes' => array(
		'pixels' => array(
			'default' => '15',
			'description' => esc_html__('Height in Pixels', 'ABdev_incomeup'),
		),
		'responsive_hide_mobile' => array(
			'description' => esc_html__( 'Hide Spacer on Mobile Size', 'ABdev_incomeup' ),
			'default' => '0',
			'type' => 'checkbox',
		),
		'responsive_hide_tablet' => array(
			'description' => esc_html__( 'Hide Spacer on Tablet Size', 'ABdev_incomeup' ),
			'default' => '0',
			'type' => 'checkbox',
		),
	),
