...
$tcvpb_elements['ul_tc'] = array(
	'name' => esc_html__('Unordered List', 'ABdev_incomeup' ),
	'type' => 'block',
	'icon' => 'pi-list',
	'category' =>  esc_html__('Content', 'ABdev_incomeup'),
	'child' => 'li_tc',
	'child_title' => esc_html__('List Item', 'ABdev_incomeup'),
	'child_button' => esc_html__('Add List Item', 'ABdev_incomeup'),
	'attributes' => array(
		'dummy' => array(
			'type' => 'hidden',
		),
		...
		'delay' => array(
			'description' => esc_html__('Inner Delay (ms)', 'ABdev_incomeup'),
			'default' => '0',
			'tab' => esc_html__('Animation', 'ABdev_incomeup'),
		),
		'id' => array(
...
$tcvpb_elements['li_tc'] = array(
	'name' => esc_html__('List Item', 'ABdev_incomeup' ),
	'type' => 'child',
	'icon' => 'pi-customize',
	'attributes' => array(
		'icon' => array(
	...
	'content' => array(
		'description' => esc_html__('Item Content', 'ABdev_incomeup'),
	)
);
