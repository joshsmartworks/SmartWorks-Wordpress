	...
	<div class="row">
		<div id="portfolio_single_column" class="<?php echo (isset($values['ABdev_portfolio_page_layout'][0])) ? esc_attr($values['ABdev_portfolio_page_layout'][0]) : '' ;?> <?php echo (isset($values['ABdev_portfolio_page_layout'][0]) && $values['ABdev_portfolio_page_layout'][0]=='portfolio_full_width' )?'span12 content':'span9 content';?> <?php echo (isset($values['ABdev_portfolio_page_layout'][0]) && $values['ABdev_portfolio_page_layout'][0]=='portfolio_left_sidebar')?'content_with_left_sidebar': ( (isset($values['ABdev_portfolio_page_layout'][0]) && $values['ABdev_portfolio_page_layout'][0]=='portfolio_right_sidebar') ?'content_with_right_sidebar' : '');?>">
			...
			?>
					...
					<?php if(isset($values['ABdev_portfolio_gallery_style'][0]) && $values['ABdev_portfolio_gallery_style'][0] == 1):?>
